...
import { Pill, Droplets, Circle, Syringe, Package, Heart, Stethoscope, Tag, Loader2, ArrowLeft } from 'lucide-react';
...
const AllCategoriesPage = () => {
  ...
  if (isLoading) {
    return (
      <>
        <SEOHelmet
          title="All Categories - CureBay Online Pharmacy"
          description="Browse all medicine categories at CureBay. Find the right medication for your health needs from our comprehensive selection."
          keywords="medicine categories, healthcare products, pharmacy categories"
  ...
  if (error) {
    return (
      <>
        <SEOHelmet
          title="All Categories - CureBay Online Pharmacy"
          description="Browse all medicine categories at CureBay."
          keywords="medicine categories, healthcare products"
          url={window.location.href}
        />
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-300 transition-colors">
              Browse our comprehensive selection of medicine categories
            </p>
          </div>
                    ...
                    <Card className="h-full transition-all duration-300 hover:shadow-xl hover:-translate-y-1 border-0 shadow-md">
                      <CardContent className="p-0">
                        ...
                        <div className="p-6">
                          ...
                          <p className="text-gray-600 dark:text-gray-300 text-sm mb-4 transition-colors line-clamp-2">
